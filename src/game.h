...
void Game_init(Game *game, Player *_playero, Player *_playerx, Ui *_ui, char ui_mode, BigBoard *_board, int game_size);   // start and initialize game   // start and initialize game
